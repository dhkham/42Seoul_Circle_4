...
/*   Updated: 2023/10/13 21:24:09 by dkham            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// default constructor
Cat::Cat() {
    type = "Cat"; // set the type attribute from AAnimal class
...
Cat& Cat::operator=(const Cat& other) {
    ...
    if (this != &other) {
        AAnimal::operator=(other); // call the copy assignment operator of the base class
